...
public class PositionMarker extends MapObject
{
    ...
    private  int MATRIX_SAVE_FLAG = 0x01;
    ...
    public void setBearingEnabled(boolean hasBearing)
    {
        ...
        if (hasBearing) {
            ...
            if (arrowPointerPivotPoint == null) {
            	setPivotPoint(PivotFactory.createPivotPoint(arrowPointerDrawable, PivotFactory.PivotPosition.PIVOT_CENTER));
            } else {
            ...
            if (roundPointerPivotPoint == null) {
            	setPivotPoint(PivotFactory.createPivotPoint(roundPointerDrawable, PivotFactory.PivotPosition.PIVOT_CENTER));
            } else {
