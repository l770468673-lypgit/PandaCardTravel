...
public class StringUtils {
    ...
    /**
     *  <pre>
     * StringUtils.isBlank(null,false)      = true
     * StringUtils.isBlank("",false)        = true
     * StringUtils.isBlank(" ",false)       = false
     * StringUtils.isBlank(" ",true)       = true
     * StringUtils.isBlank("bob",true)     = false
     * StringUtils.isBlank("bob",false)     = false
     * StringUtils.isBlank("  bob  ",false) = false
     * StringUtils.isBlank("  bob  ",true) = false
     * </pre>
     * @param source
     ...
     * @return
     */
    public static boolean isBlank(String source,boolean trim){
    	if(source==null)
    		return true;
    	if(trim){
    		source = trim(source);
    ...
    /**
	 *
	 * @Title: getValueFromUrl
	 * @Description: 从URL取得参数值
	 * @param url
	 * @param key
	 * @return
	 */
