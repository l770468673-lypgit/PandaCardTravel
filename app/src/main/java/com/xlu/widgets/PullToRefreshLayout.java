...
public class PullToRefreshLayout extends RelativeLayout {
    private ListViewType type = ListViewType.all;
    ...
    public static final int SUCCEED_FINISHED = 10;
    // 刷新失败
    ...
    public void refreshFinish(int refreshResult) {
        if(refreshView==null||refreshStateImageView==null||refreshStateTextView==null)
            return;
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                break;
            case SUCCEED_FINISHED:
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.pull_finish);
                loadStateImageView
                        .setBackgroundResource(R.drawable.refresh_succeed);
                break;
            case FAIL:
    ...
    public void setType(ListViewType type) {
        this.type = type;
    }

    private void changeState(int to) {
        if(refreshView==null||refreshStateImageView==null||refreshStateTextView==null||pullView==null||pullUpView==null||loadStateTextView==null||loadStateTextView==null||loadStateImageView==null)
            return;
        state = to;
        switch (state) {
            case INIT:
    ...
    private void onlyPullDown() {
        canPullDown = true;
        canPullUp = false;
    }

    private void onlyPullUp() {
        canPullDown = false;
        canPullUp = true;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                timer.cancel();
                mEvents = 0;
                if (type == ListViewType.all)
                    releasePull();
                else if (type == ListViewType.up)
                    onlyPullUp();
                else if (type == ListViewType.down)
                    onlyPullDown();
                break;
    ...
    public interface OnMyOnscrollListener {
        void onMyScroll(int firstVisibleItem);
    }
