...
public class ProgressWheel extends View {
	 ...
	 * ********* DEFAULTS * **********
	 */
	private int circleRadius = 28;// 鍦嗗湀鐨勫崐寰�
	private int barWidth = 4;// 婊戝潡瀹藉害
	private int rimWidth = 4;// 鍦嗙幆瀹藉害

	private final int barLength = 16;
	private final int barMaxLength = 270;// 婊戝潡鏈�澶ч暱搴�

	private boolean fillRadius = false;// 鏄惁鍗犳弧鍖哄煙

	private double timeStartGrowing = 0;
	private double barSpinCycleTime = 460;// 鏃嬭浆鍛ㄦ湡(婊戝潡灏鹃儴)
	private float barExtraLength = 0;//
	private boolean barGrowingFromFront = true;

	private long pausedTimeWithoutGrowing = 0;// 鏆傚仠澧為暱鐨勬椂闂�
	private final long pauseGrowingTime = 200;// 鏃堕棿闂撮殧

	// Colors (with defaults)
	private int barColor = 0xAA000000;// 婊戝潡棰滆壊
	...
	// Rectangles
	private RectF circleBounds = new RectF();// 鎺т欢鍖哄煙
	...
	private boolean linearProgress;// 鏄惁涓虹嚎鍨嬭繘搴�

	private float mProgress = 0.0f;
	private float mTargetProgress = 0.0f;
	private boolean isSpinning = false;// 鏄惁寰幆
	...
	/**
	 * 浠ｆ浛onAttachedToWindow锛屾潵璁惧畾鎺т欢鍜岀敾绗斿睘鎬�
	 */
	@Override
	...
	private void setupPaints() {
		...
		barPaint.setAntiAlias(true);// 鎶楅敮榻�
		barPaint.setStyle(Style.STROKE);// 绌哄績鍦嗙幆
		barPaint.setStrokeWidth(barWidth);// 鍦嗙幆瀹藉害
	...
	public interface ProgressCallback {
		/**
		 * 褰撹繘搴﹀埌杈炬煇涓�兼椂锛屼负閬垮厤娴偣绮惧害锛屽皢杩涘害璁句负涓や綅灏忔暟 杩涘害涓�0.00-1.00 Method to
		 * call when the progress reaches a value in order to avoid float
		 * precision issues, the progress is rounded to a float with two
		 * decimals.
		 * <p/>
