...
public class AllCardOrderAdapter extends RecyclerView.Adapter<AllCardOrderAdapter.ViewHolder> {
    ...
    public AllCardOrderAdapter(Context context) {
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AllCardOrderAdapter.ViewHolder(view);
    }
