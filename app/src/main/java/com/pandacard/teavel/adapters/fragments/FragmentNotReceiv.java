 ...
 * Use the {@link FragmentNotReceiv#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentNotReceiv extends Fragment {
    ...
    public FragmentNotReceiv() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static FragmentNotReceiv newInstance(String param1, String param2) {
        FragmentNotReceiv fragment = new FragmentNotReceiv();
    ...
    private void loadDate() {
        ...
        Call<MyOrderList> myOrderList = HttpManager.getInstance().getHttpClient3().getMyOrderList(
                ShareUtil.getString(HttpRetrifitUtils.WECHAT_USERID), HttpRetrifitUtils.STATE_NOTRECEIV);
