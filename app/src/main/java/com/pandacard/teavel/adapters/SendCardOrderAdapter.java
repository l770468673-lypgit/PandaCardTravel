...
public class SendCardOrderAdapter extends RecyclerView.Adapter<SendCardOrderAdapter.ViewHolder> {
    ...
    public SendCardOrderAdapter(Context context) {
        mContext = context;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SendCardOrderAdapter.ViewHolder(view);
    }
